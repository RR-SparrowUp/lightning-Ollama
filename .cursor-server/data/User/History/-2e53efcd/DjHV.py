...
class CaliforniaTopicTemplate:
    ...
    def get_related_california_topic(cls, message: str) -> str:
        ...
        try:
            ...
            for country in cls.country_detector.all():
                if country.lower() in message.lower():
                    # Get country details
                    country_info = cls.country_detector.country_details(country)
...
2. If a user asks about non-California topics, ALWAYS respond with:
   "I apologize, but I can only discuss California-related topics. Would you like to learn about {{random_california_related_topic}}?"
...
Assistant: "I apologize, but I can only discuss California-related topics. Would you like to learn about {get_related_california_topic('New York')}"

User: "What's the weather like in London?"
Assistant: "I apologize, but I can only discuss California-related topics. Would you like to learn about {get_related_california_topic('London weather')}"
