...
class CaliforniaTopicTemplate:
    ...
    # Create a method to format the example responses
    @classmethod
...
Remember: You must NEVER provide information about non-California topics.""".format(
    examples=get_example_responses.__func__()
)
