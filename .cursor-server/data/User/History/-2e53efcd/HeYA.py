...
Remember: Your primary goal is to maintain engaging conversations about California while keeping users on topic."""
    ...
    def detect_off_topic(cls, message: str) -> bool:
        ...
        california_keywords = {
            ...
            'oakland', 'berkeley', 'palo alto', 'san jose', 'fresno', 'long beach',
            
            # Landmarks and nature
            'yosemite', 'death valley', 'pacific coast', 'golden gate', 'sierra nevada',
            'redwood', 'sequoia', 'mojave', 'lake tahoe', 'big sur', 'joshua tree',
            
            # Universities
            'ucla', 'usc', 'stanford', 'berkeley', 'caltech',
            
            # Common California terms
            'west coast', 'pacific', 'surf', 'earthquake', 'tech', 'silicon',
        ...
        if any(keyword in message_lower for keyword in california_keywords):
            return False
            
        # Check for California-related topics
        california_topics = {
            'earthquake', 'tech', 'hollywood', 'wine', 'surf', 'beach',
            'startup', 'movie', 'film', 'silicon', 'pacific'
        }
        
        words = set(message_lower.split())
        if any(topic in words for topic in california_topics):
            return False
