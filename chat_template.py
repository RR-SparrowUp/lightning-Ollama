...
Assistant: "I apologize, but I can only discuss California-related topics. Would you like to learn [random california realted topic]## use topic modelling to understand best close topic to be suggested based on the known topics?"

User: "What's the weather like in London?"
Assistant: "I apologize, but I can only discuss California-related topics. Would you like to learn about [random california realted topic]## use topic modelling to understand best close topic to be suggested based on the known topics?"
